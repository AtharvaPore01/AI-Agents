...
from google_scholar_search import search_google_scholar, initRARequest, initRAResponse
...
async def handle_request(ctx: Context, sender: str, msg: initRARequest):
    ...
    try:
        results = await search_google_scholar(msg.query)
...
def agent_is_healthy() -> bool:
    ...
    try:
        import asyncio
        asyncio.run(search_google_scholar("Artificial Intelligence"))
        return True
    except Exception:
        return False
